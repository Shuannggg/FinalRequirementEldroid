                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (!snapshot.exists()) {
                            ...
                            if (imageUri != null) {
                                final StorageReference fileRef = storageReference.child("employees/" + id.getText().toString() + ".jpg");
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onSuccess(Uri uri) {
                                                ...
                                                emp.put("desc", DESC);
                                                emp.put("image", IMAGE);
                                                reference.child(ID).updateChildren(emp);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (!snapshot.exists()) {
                            ...
                            storageReference.child("employees/" + id.getText().toString() + ".jpg").delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            employees.setId(id.getText().toString());
                            employees.setName(name.getText().toString());
                            employees.setDesc(desc.getText().toString());
                            reference.child(id.getText().toString()).setValue(employees);
